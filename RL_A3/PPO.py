...
def ppo_hypertuning():
    ...
    ppo_tuning(lr=.00025, net_struct=(1, 32), gd_epochs=10, batch_size=32, col='mediumturquoise', label=label)

    label = 'lr=.0005, net_struct=(1, 64), gd_epochs=10, batch_size=64'
    ppo_tuning(lr=.00025, net_struct=(2, 64), gd_epochs=10, batch_size=64, col='darkorange', label=label)

    label = 'lr=.0005, net_struct=(1, 64), gd_epochs=10, batch_size=128'
    ppo_tuning(lr=.0005, net_struct=(1, 64), gd_epochs=10, batch_size=32, col='indigo', label=label)

    label = 'lr=.0005, net_struct=(1, 32), gd_epochs=10, batch_size=64'
    ppo_tuning(lr=.0005, net_struct=(2, 64), gd_epochs=10, batch_size=64, col='forestgreen', label=label)
